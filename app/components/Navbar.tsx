...
const Navbar = () => {
    ...
    const NAVBAR_STYLES = `@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@400;600;700;800&family=Inter:wght@400;500;600;700&display=swap');
html,body{margin:0;padding:0;overflow-x:hidden;}
*,*::before,*::after{box-sizing:border-box;}
*:focus{outline:none;}
:root{--g50:#fafafa;--g100:#f4f4f5;--g200:#e4e4e7;--g300:#d4d4d8;--g400:#a1a1aa;--g500:#71717a;--g600:#52525b;--g700:#3f3f46;--g800:#27272a;--g900:#18181b;--nv-utility-h:32px;--nv-main-h:70px;--nv-total-h:102px;--nv-mobile-h:64px;}
...
@media(max-width:980px){.nv-links{display:none;}.nv-ham{display:flex;}.nv-ov{display:block;}.nv-sw{display:none;}.nv-btn-prim{display:none;}.nv-main{height:var(--nv-mobile-h);}.nv-utility{display:none !important;}}
