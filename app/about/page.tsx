...
.panel-services    { z-index: 4;  background: #fff; }
.panel-team        { z-index: 5;  background: #fafafa; }
.panel-vision      { z-index: 6;  background: #f8f7f4; }
...
.desktop-layout {
  ...
  display: grid; grid-template-columns: 160px 400px 160px;
  gap: 0 72px; align-items: center; padding: 120px 0 80px;
}
...
.panel-hero.animate .p1 { animation: popIn .65s cubic-bezier(.34,1.5,.64,1) .28s forwards, float1 5.5s ease-in-out 1.4s infinite; }
.panel-hero.animate .p2 { animation: popIn .65s cubic-bezier(.34,1.5,.64,1) .42s forwards, float2 6.0s ease-in-out 1.6s infinite; }
.panel-hero.animate .p3 { animation: popIn .65s cubic-bezier(.34,1.5,.64,1) .56s forwards, float3 5.0s ease-in-out 1.8s infinite; }
.panel-hero.animate .p4 { animation: popIn .65s cubic-bezier(.34,1.5,.64,1) .70s forwards, float4 4.8s ease-in-out 2.0s infinite; }
.center-text { text-align: center; display: flex; flex-direction: column; align-items: center; }
.center-text > * { opacity: 0; }
.panel-hero.animate .badge   { animation: fadeDown .55s cubic-bezier(.34,1.2,.64,1) .08s forwards; }
.panel-hero.animate .heading { animation: fadeUp   .75s cubic-bezier(.16,1,.3,1)    .22s forwards; }
.panel-hero.animate .sub     { animation: fadeUp   .65s ease                        .40s forwards; }
.panel-hero.animate .buttons { animation: fadeUp   .65s ease                        .56s forwards; }
...
/* ──────────────────────────────────────────
   PANEL 2 — CEO QUOTE
────────────────────────────────────────── */
.ceo-bg-quote { position: absolute; top: -20px; left: 50%; transform: translateX(-50%); font-family: 'Outfit', sans-serif; font-size: 28rem; font-weight: 900; color: rgba(255,255,255,.025); line-height: 1; pointer-events: none; user-select: none; z-index: 0; }
...
.panel-ceo.in-view .ceo-quote em { animation: shimmer 3.5s linear 1.2s infinite; }
...
.panel-ceo.in-view .ceo-label    { animation: fadeInUp .65s cubic-bezier(.16,1,.3,1) .10s forwards; }
.panel-ceo.in-view .ceo-quote    { animation: fadeInUp .8s  cubic-bezier(.16,1,.3,1) .26s forwards; }
.panel-ceo.in-view .ceo-divider  { animation: fadeInUp .55s ease .52s forwards; }
.panel-ceo.in-view .ceo-identity { animation: fadeInUp .65s cubic-bezier(.16,1,.3,1) .66s forwards; }
...
.panel-who.in-view .who-img-wrap { clip-path: inset(0 0% 0 0 round 24px); }
...
.panel-who.in-view .who-img-wrap img { transform: scale(1); }
...
.panel-who.in-view .who-eyebrow { opacity: 1; transform: translateY(0); }
.who-eyebrow-line { width: 0; height: 1.5px; background: #d4d4d8; transition: width .6s cubic-bezier(.16,1,.3,1) .55s; }
.panel-who.in-view .who-eyebrow-line { width: 20px; }
...
.panel-who.in-view .who-title { opacity: 1; transform: translateY(0); }
...
.panel-who.in-view .who-body { opacity: 1; transform: translateY(0); }
...
.panel-who.in-view .who-body-2 { opacity: 1; transform: translateY(0); }
...
.panel-who.in-view .who-rule { transform: scaleX(1); }
...
.serv-header { text-align: center; margin-bottom: 36px; }
...
.panel-team.in-view .team-header { opacity: 1; transform: translateY(0); }
...
.panel-team.in-view .team-eyebrow-line { width: 20px; }
...
.panel-vision.in-view .vision-header { opacity: 1; transform: translateY(0); }
...
.panel-vision.in-view .vision-carousel { opacity: 1; transform: translateY(0); }
...
.vision-card { flex: 0 0 100%; width: 100%; background: #fff; border: 1.5px solid #ebebeb; border-radius: 24px; padding: 44px 44px 40px; position: relative; overflow: hidden; box-sizing: border-box; }
...
.panel-vision.in-view .vision-card::before { transform: scaleX(1); transition-delay: .55s; }
.vision-card--dark { background: #18181b; border-color: #18181b; }
...
.test-center { flex: 1; position: relative; z-index: 2; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 40px 36px; min-width: 0; overflow: hidden; }
.test-badge { display: inline-flex; align-items: center; gap: 7px; background: #fff; border: 1.5px solid #e4e4e7; padding: 5px 14px; border-radius: 99px; margin-bottom: 14px; font-size: .62rem; font-weight: 700; letter-spacing: .12em; text-transform: uppercase; color: #71717a; opacity: 0; transform: translateY(14px); transition: opacity .6s cubic-bezier(.16,1,.3,1) .12s, transform .6s cubic-bezier(.16,1,.3,1) .12s; }
.panel-testimonials.in-view .test-badge { opacity: 1; transform: translateY(0); }
.test-badge-dot { width: 6px; height: 6px; border-radius: 50%; background: #18181b; flex-shrink: 0; }
.test-heading { font-family: 'Outfit', sans-serif; font-size: clamp(1.6rem,2.6vw,2.4rem); font-weight: 900; line-height: 1.08; letter-spacing: -.04em; color: #18181b; text-align: center; margin-bottom: 6px; opacity: 0; transform: translateY(16px); transition: opacity .65s cubic-bezier(.16,1,.3,1) .22s, transform .65s cubic-bezier(.16,1,.3,1) .22s; }
.test-heading-muted { color: #a1a1aa; font-weight: 800; }
.panel-testimonials.in-view .test-heading { opacity: 1; transform: translateY(0); }
.test-sub { font-size: .84rem; color: #71717a; line-height: 1.7; text-align: center; margin-bottom: 28px; max-width: 360px; opacity: 0; transform: translateY(12px); transition: opacity .6s cubic-bezier(.16,1,.3,1) .3s, transform .6s cubic-bezier(.16,1,.3,1) .3s; }
.panel-testimonials.in-view .test-sub { opacity: 1; transform: translateY(0); }
.trev-slider { width: 100%; max-width: 540px; opacity: 0; transform: translateY(20px); transition: opacity .7s cubic-bezier(.16,1,.3,1) .4s, transform .7s cubic-bezier(.16,1,.3,1) .4s; }
.panel-testimonials.in-view .trev-slider { opacity: 1; transform: translateY(0); }
...
.trev-author { display: flex; align-items: center; gap: 14px; border-top: 1px solid #f0f0f0; padding-top: 18px; position: relative; z-index: 1; }
.trev-avatar { width: 52px; height: 52px; border-radius: 50%; overflow: hidden; border: 2px solid #e4e4e7; flex-shrink: 0; background: #f0f0f0; }
...
.trev-nav { display: flex; align-items: center; justify-content: space-between; width: 100%; max-width: 540px; margin-top: 18px; }
.trev-nav-dots { display: flex; gap: 7px; }
.trev-nav-dot { width: 7px; height: 7px; border-radius: 50%; background: #d4d4d8; border: none; padding: 0; cursor: pointer; transition: background .25s, transform .25s; }
...
.trev-arrow { width: 40px; height: 40px; border-radius: 50%; border: 1.5px solid #e4e4e7; background: #fff; display: flex; align-items: center; justify-content: center; cursor: pointer; color: #18181b; transition: background .2s, border-color .2s, transform .22s cubic-bezier(.34,1.4,.64,1), box-shadow .2s; }
...
.cta-sub { font-size: 1rem; color: rgba(255,255,255,.45); line-height: 1.75; max-width: 420px; margin-bottom: 44px; }
...
.cta-stat-num { font-family: 'Outfit', sans-serif; font-size: 2.4rem; font-weight: 900; letter-spacing: -.04em; color: #fff; line-height: 1; }
.cta-stat-label { font-size: .68rem; font-weight: 600; color: rgba(255,255,255,.32); letter-spacing: .09em; text-transform: uppercase; text-align: center; line-height: 1.4; }
...
@media (max-width: 640px) {
  ...
  .mob-text > * { opacity: 0; }
  .panel-hero.animate .mob-heading { animation: fadeUp .7s cubic-bezier(.16,1,.3,1) .25s forwards; }
  .panel-hero.animate .mob-sub     { animation: fadeUp .6s ease .42s forwards; }
  ...
  .panel-hero.animate .mp1 { animation: popIn .6s cubic-bezier(.34,1.5,.64,1) .55s forwards, float1 5.5s ease-in-out 1.4s infinite; }
  .panel-hero.animate .mp2 { animation: popIn .6s cubic-bezier(.34,1.5,.64,1) .68s forwards, float2 6.0s ease-in-out 1.6s infinite; }
  .panel-hero.animate .mp3 { animation: popIn .6s cubic-bezier(.34,1.5,.64,1) .81s forwards, float3 5.0s ease-in-out 1.8s infinite; }
  .panel-hero.animate .mp4 { animation: popIn .6s cubic-bezier(.34,1.5,.64,1) .94s forwards, float4 4.8s ease-in-out 2.0s infinite; }
  ...
  .serv-panel { grid-template-columns: 1fr; gap: 16px; width: 100%; animation: slideUp .35s cubic-bezier(.16,1,.3,1) .04s forwards; opacity: 0; }
...
const AboutUs = () => {
    ...
    useEffect(() => {
        ...
        const o1 = obs(ceoRef.current, 'in-view', undefined, 0);
        const o2 = obs(whoRef.current, 'in-view', () => {
            if (statCountedRef.current) return;
            statCountedRef.current = true;
            statRefs.current.forEach((el, i) => {
                if (!el) return;
                setTimeout(() => {
                    el.classList.add('card-in');
                    const n = el.querySelector('.stat-num') as HTMLElement | null;
                    if (n) countUp(n, +(el.dataset.target ?? '0'), el.dataset.suffix || '');
                }, 350 + i * 140);
            });
        }, 0.05);
        const o3 = obs(servRef.current, 'in-view', undefined, 0);
        const o4 = obs(teamRef.current, 'in-view', () => {
        ...
        return () => {
            clearTimeout(t);
            [o1, o2, o3, o4, o5, o6].forEach(o => o?.disconnect());
            ctaObs.disconnect();
        };
    }, []);
    ...
    useEffect(() => {
        ...
        if (!grid) return;
        const onScroll = () => {
            const cardW = grid.scrollWidth / 4;
            setActiveDot(Math.min(3, Math.max(0, Math.round(grid.scrollLeft / cardW))));
        };
    ...
    const team = [
        ...
        { name: 'Sara Al Mansouri', role: 'Senior Property Advisor', specialty: 'Off-Plan & Investment', deals: '180+', image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&q=85', langs: ['Arabic', 'English', 'French'] },
        { name: 'James Harrington', role: 'Head of Leasing', specialty: 'Commercial & Retail', deals: '220+', image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&q=85', langs: ['English'] },
